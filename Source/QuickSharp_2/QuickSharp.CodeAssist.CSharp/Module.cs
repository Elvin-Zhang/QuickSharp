...
namespace QuickSharp.CodeAssist.CSharp
{
    public class Module : IQuickSharpPlugin
    {
        ...
        public string GetID()
        {
            return "CFAFCDCA-A76A-45F8-9608-538685821101";
        }

        public string GetName()
        {
            return "QuickSharp Code Assist C# Support";
        }
        ...
        {
            return "Provides C# support for the Code Assist plugin.";
        }
