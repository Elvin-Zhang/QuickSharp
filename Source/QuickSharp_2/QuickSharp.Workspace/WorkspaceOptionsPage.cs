...
namespace QuickSharp.Workspace
{
    ...
    /// </summary>
    public class WorkspaceOptionsPage : OptionsPage
    {
        ...
        public WorkspaceOptionsPage()
        {
            ...
            Name = Constants.UI_OPTIONS_PAGE_WORKSPACE;
            ...
            _backupDirectoryLabel.Text = Resources.OptionsBackupPathLabel;
            ...
            _backupDirectoryWarningLabel.Text = Resources.OptionsBackupPathWarningLabel;
            ...
            if (ApplicationManager.GetInstance().ClientProfile.HaveFlag(
                ClientFlags.WorkspaceEnableTitleBarUpdate))
